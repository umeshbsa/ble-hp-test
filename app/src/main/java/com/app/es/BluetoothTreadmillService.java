...
public class BluetoothTreadmillService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new C02481();
    public BluetoothGattCharacteristic mNotifyCharacteristic;
    public BluetoothGattCharacteristic mWriteCharacteristic;

    /* renamed from: com.hankang.phone.treadmill.service.BluetoothTreadmillService$1 */
    class C02481 extends BluetoothGattCallback {
        C02481() {
        }

        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            LogUtil.m294i(BluetoothTreadmillService.TAG, "mGattCallback", "status=" + status + "//newState=" + newState);
            if (newState == 2) {
                String intentAction = BluetoothTreadmillService.ACTION_GATT_CONNECTED;
                LogUtil.m294i(BluetoothTreadmillService.TAG, "mGattCallback", "discoverServices=" + BluetoothTreadmillService.this.mBluetoothGatt.discoverServices());
